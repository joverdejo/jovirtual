...
export const delay2 = new Tone.FeedbackDelay("8n", 0.7);
...
export const verb3 = new Tone.Reverb({decay:10, wet:0.9});
export const delay3 = new Tone.FeedbackDelay("8n", 0.7);
...
export var samplersList = [[filter1,verb1,delay1,s1],[filter2,verb2,delay2,s2],[filter3,verb3,delay3,s3]]